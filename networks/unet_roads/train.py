...
from networks.unet_roads.unet import build_unet
...
def train_unet(data_dir, logdir, weights_dir, input_size, nb_classes, batch_size, initial_epoch):
    ...
    val_generator, val_samples = create_generator(os.path.join(data_dir, 'train'), input_size, batch_size, nb_classes, rescale=False, binary=True)
