...
from keras.layers import Conv2D, MaxPooling2D, UpSampling2D, Cropping2D, concatenate, Flatten, Dense, BatchNormalization
...
def build_unet(nb_classes, input_width=473, input_height=473, nChannels=1):
    ...
    model.compile(optimizer=Adam(lr=1e-4, clipnorm=1, clipvalue=0.5), loss='categorical_crossentropy', metrics=['accuracy'])
