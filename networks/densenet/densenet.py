...
from keras.layers import Activation, BatchNormalization, AveragePooling2D, Conv2D, Dropout, concatenate, MaxPooling2D, \
    UpSampling2D, Conv2DTranspose, Reshape
from keras.models import Model
from keras.optimizers import Adam
from keras.regularizers import l2

from keras_utils.metrics import soft_jaccard_loss, jaccard_distance, jaccard_without_background
...
def build_densenet(input_size, classes, config=56):
    ...
    model.compile(loss=loss, optimizer=optimizer, metrics=['acc', loss, jaccard_distance, jaccard_without_background])
    return model
