...
def callbacks(logdir, weightsdir, filename, monitor_val='val_acc', steps_per_epoch=0):
    ...
    plateau_callback = CyclicLR(base_lr=1e-5, max_lr=1e-3, step_size=3*steps_per_epoch, mode='triangular2')
