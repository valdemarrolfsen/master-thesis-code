...
from keras_utils.metrics import general_jaccard, mean_intersection_over_union, jaccard_without_background
...
def run(args):
    ...
    IOU = []
    other_IOU = K.eval(K.mean(jaccard_without_background(K.variable(masks), K.variable(probs))))
